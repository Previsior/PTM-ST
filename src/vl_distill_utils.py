...
class syn_dataset:
    def __init__(self, image_syn, text_syn, sim_generator, syn_lr_img, syn_lr_txt):
        self.image_syn = image_syn
        self.text_syn = text_syn
        self.sim_generator = sim_generator
        self.syn_lr_img = syn_lr_img
        self.syn_lr_txt = syn_lr_txt
...
def load_or_process_file(file_type, process_func, args, data_source):
    ...
    """
    filename = f'./npz/{args.dataset}_{args.text_encoder}_{file_type}_embed.npz'
