...
#     --Iteration 2000 2000 --subset_num 2 --ema_decay 0.99 --image_trainable
...
#     --Iteration 2000 --subset_num 2 --ema_decay 0.99 --image_trainable

# # COCO 500
# python distill_ptm-st.py --dataset=coco \
...
#     --lr_sim 50 --sim_type full \
#     --num_queries 200 299 --name ${EXP_NAME} \
#     --Iteration 2000 2000 --subset_num 2 --ema_decay 0.99 --out_embedding 2048
...
#     --lr_sim 50 --sim_type full \
#     --num_queries 99 --name ${EXP_NAME} \
#     --Iteration 2000 --subset_num 2 --ema_decay 0.99 --out_embedding 2048
